...
void EmptyLinkFunctionForGeneratedCodeDelegateHandler_init() {}
	...
	UPackage* Z_Construct_UPackage__Script_DelegateHandler()
	{
		...
		if (!ReturnPackage)
		{
			static UObject* (*const SingletonFuncArray[])() = {
				(UObject* (*)())Z_Construct_UDelegateFunction_DelegateHandler_EventMessage__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_DelegateHandler_NetworkMessage__DelegateSignature,
			};
			static const UE4CodeGen_Private::FPackageParams PackageParams = {
				"/Script/DelegateHandler",
				SingletonFuncArray,
